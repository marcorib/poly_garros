    ...
    public function run()
    {
        ...
        \DB::table('cms_users')->insert(array (
            ...
            array (
                ...
                'name' => 'Aurélie Toto',
                'photo' => NULL,
                'email' => 'aurelie.toto@grand-auch.fr',
                'password' => '$2y$10$Xxh4a1XfQSckBuWg1l.GmOSm4oEJ8QGuhLiSAJuCRo07MYVca66dW',
                'id_cms_privileges' => 3,
                'created_at' => '2018-12-10 10:53:18',
                'updated_at' => '2018-12-13 12:54:50',
                'status' => NULL,
            ),
            6 => 
            array (
            ...
            array (
                'id' => 8,
                'name' => 'Helder Morais',
                'photo' => 'uploads/5/2018-12/logo_cd32.jpg',
                'email' => 'morais.helder@hotmail.fr',
                'password' => '$2y$10$DjenaVlXqyJBWpaVlPzf9.tBtZeNj5JbAKTmsCR60Ztfh.Xjw327S',
                'id_cms_privileges' => 2,
            ...
            array (
                'id' => 9,
                'name' => 'Houssine Zarrik',
                'photo' => 'uploads/5/2018-12/logo_cd32.jpg',
                'email' => 'houssine.zarrik@orange.fr',
                'password' => '$2y$10$ooaf3QMlahUNEPo0VZYqzeyw4Rm5jqxEwAeI2vYzlt9/JWRh4IO0C',
                'id_cms_privileges' => 2,
